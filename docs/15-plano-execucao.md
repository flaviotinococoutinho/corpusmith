...
| 12 | **F3 → F4 → F5 → F6 → F7** — F3-PR1 (P-7, colisão) ✅ **ENTREGUE** (RFC-003 `docs/20` + ADR-50, v1.9.8); resta o P-3 (veredito e vitalidade) | — | Daí em diante a ordem do `14` se sustenta. F3 exige **RFC** (§1.1) — cumprido para o P-7; F5 herda a dívida do `MD_LINK` já resolvida na F1 |
