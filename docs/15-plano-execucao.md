...
| 6 | ✅ **F1-PR6** · deep-link da fila + `CurationDialog` — **ENTREGUE** | 6 | ⚠ Antecipado (era 6º). Com PR1+PR2+PR4, os **dois** itens do topo da fila já têm ato com preview: converte quatro PRs de infraestrutura em algo perceptível meses antes |
